...
var _createClass = function () {
    ...
    function b(a, c) {
        ...
        var d = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this)), e = void 0,
            f = void 0;
        if (d.element = a, d.version = b.version, d.defaultOptions.previewTemplate = d.defaultOptions.previewTemplate.replace(/\n*/g, ''), d.clickableElements = [], d.listeners = [], d.files = [], 'string' == typeof d.element && (d.element = document.querySelector(d.element)), !d.element || null == d.element.nodeType) {
    ...
    return _inherits(b, a), _createClass(b, null, [{
        ...
        key: 'removeFile', value: function (a) {
            if (a.status === b.UPLOADING && this.cancelUpload(a), this.files = without(this.files, a), this.emit('removedfile', a), 0 === this.files.length) {
        ...
        key: 'cancelUpload', value: function (a) {
            if (a.status === b.UPLOADING) {
                ...
                a.status !== b.ADDED && a.status !== b.QUEUED || (a.status = b.CANCELED, this.emit('canceled', a), this.options.uploadMultiple && this.emit('canceledmultiple', [a]));
            }
        ...
        key: '_finished', value: function (a, c, d) {
            ...
            if (this.options.uploadMultiple && (this.emit('successmultiple', a, c, d), this.emit('completemultiple', a)), this.options.autoProcessQueue) {
                return this.processQueue();
            }
        },
    }, {
        key: '_errorProcessing', value: function (a, c, d) {
            ...
            if (this.options.uploadMultiple && (this.emit('errormultiple', a, c, d), this.emit('completemultiple', a)), this.options.autoProcessQueue) {
                return this.processQueue();
            }
        },
    }], [{
    ...
    return _createClass(a, null, [{
        ...
        key: "encode64", value: function (a) {
            for (var b = "", c = void 0, d = void 0, e = "", f = void 0, g = void 0, h = void 0, i = "", j = 0; ;) {
                if (c = a[j++], d = a[j++], e = a[j++], f = c >> 2, g = (3 & c) << 4 | d >> 4, h = (15 & d) << 2 | e >> 6, i = 63 & e, isNaN(d) ? h = i = 64 : isNaN(e) && (i = 64), b = b + this.KEY_STR.charAt(f) + this.KEY_STR.charAt(g) + this.KEY_STR.charAt(h) + this.KEY_STR.charAt(i), c = d = e = "", f = g = h = i = "", !(j < a.length)) {
                    break;
                }
            }
            return b
        ...
        key: "decode64", value: function (a) {
            ...
            for (k.exec(a) && console.warn("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."), a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); ;) {
                if (e = this.KEY_STR.indexOf(a.charAt(i++)), f = this.KEY_STR.indexOf(a.charAt(i++)), g = this.KEY_STR.indexOf(a.charAt(i++)), h = this.KEY_STR.indexOf(a.charAt(i++)), b = e << 2 | f >> 4, c = (15 & f) << 4 | g >> 2, d = (3 & g) << 6 | h, j.push(b), 64 !== g && j.push(c), 64 !== h && j.push(d), b = c = d = "", e = f = g = h = "", !(i < a.length)) {
                    break;
                }
            }
            return j
...
}, contentLoaded(window, Dropzone._autoDiscoverFunction);'use strict';
    ...
    return _inherits(b, a), _createClass(b, null, [{
        key: 'initClass', value: function () {
            this.prototype.Emitter = Emitter, this.prototype.events = ['drop', 'dragstart', 'dragend', 'dragenter', 'dragover', 'dragleave', 'addedfile', 'addedfiles', 'removedfile', 'thumbnail', 'error', 'errormultiple', 'processing', 'processingmultiple', 'uploadprogress', 'totaluploadprogress', 'sending', 'sendingmultiple', 'success', 'successmultiple', 'canceled', 'canceledmultiple', 'complete', 'completemultiple', 'reset', 'maxfilesexceeded', 'maxfilesreached', 'queuecomplete'], this.prototype.defaultOptions = {
                ...
                renameFile: null,
                forceFallback: !1,
                dictDefaultMessage: 'Dosyalarinizi buraya surukleyin veya tiklayiniz.',
                dictFallbackMessage: 'Your browser does not support drag\'n\'drop file uploads.',
                dictFallbackText: 'Please use the fallback form below to upload your files like in the olden days.',
                dictFileTooBig: 'File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.',
                dictInvalidFileType: 'You can\'t upload files of this type.',
