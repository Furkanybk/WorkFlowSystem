...
!function (a) {
    ...
    k.prototype = {
        ...
        _fill_yearsView: function (c, d, e, f, g, h, i) {
            for (var j, k, l, m = '', n = e / 10, o = this.picker.find(c), p = Math.floor(f / e) * e, q = p + 9 * n, r = Math.floor(this.viewDate.getFullYear() / n) * n, s = a.map(this.dates, function (a) {
                ...
                j = [d], k = null, t === p - n ? j.push('old') : t === q + n && j.push('new'), -1 !== a.inArray(t, s) && j.push('active'), (t < g || t > h) && j.push('disabled'), t === r && j.push('focused'), i !== a.noop && (l = i(new Date(t, 0, 1)), l === b ? l = {} : 'boolean' == typeof l ? l = { enabled: l } : 'string' == typeof l && (l = { classes: l }), !1 === l.enabled && j.push('disabled'), l.classes && (j = j.concat(l.classes.split(/\s+/))), l.tooltip && (k = l.tooltip)), m += '<span class="' + j.join(' ') + '"' + (k ? ' title="' + k + '"' : '') + '>' + t + '</span>';
            }
    ...
    var q = a.fn.datepicker.dates = {
        en: {
            ...
            monthsShort: ['Oca', 'Þub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Agu', 'Eyl', 'Eki', 'Kas', 'Ara'],
            today: 'Bugün',
            clear: 'Temizle',
            titleFormat: 'dd mm yyyy',
        },
    }, r = {
        viewModes: [{ names: ['günler', 'aylar'], clsName: 'günler', e: 'changeMonth' }, {
            names: ['aylar', 'yýllar'],
            clsName: 'aylar',
            e: 'changeYear',
            navStep: 1,
